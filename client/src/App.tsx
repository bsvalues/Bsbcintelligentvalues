...
const TaxAssessmentDashboardPage = () => (
  <div className="container mx-auto p-8">
    <h1 className="text-3xl font-bold mb-6">Tax Assessment Dashboard</h1>
    <p className="text-gray-600 mb-8">View and manage property assessments across the county.</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Property ID</th>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">PR-10542</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">123 Main St</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">$320,500</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-500">Mar 20, 2025</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">
                    <span className="px-2 py-1 text-xs rounded-full bg-green-100 text-green-800">Completed</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">PR-10543</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">456 Oak Ave</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">$455,000</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-500">Mar 21, 2025</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">
                    <span className="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800">In Progress</span>
                  </td>
                </tr>
                <tr>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">PR-10544</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">789 Elm St</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">$275,200</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-500">Mar 22, 2025</td>
                  <td className="px-3 py-2 whitespace-nowrap text-sm">
                    <span className="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800">Review Needed</span>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <div className="col-span-1">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4">
            <StatItem label="Total Properties" value="24,521" />
            <StatItem label="Assessed This Year" value="5,842" />
            <StatItem label="Appeals" value="142" />
            <StatItem label="Reassessments" value="783" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            <button className="w-full bg-blue-100 hover:bg-blue-200 text-blue-800 py-2 px-4 rounded flex items-center">
              <Search className="w-4 h-4 mr-2" />
              Search Properties
            </button>
            <button className="w-full bg-green-100 hover:bg-green-200 text-green-800 py-2 px-4 rounded flex items-center">
              <Building2 className="w-4 h-4 mr-2" />
              New Assessment
            </button>
            <button className="w-full bg-purple-100 hover:bg-purple-200 text-purple-800 py-2 px-4 rounded flex items-center">
              <FileText className="w-4 h-4 mr-2" />
              Generate Report
            </button>
            <button className="w-full bg-orange-100 hover:bg-orange-200 text-orange-800 py-2 px-4 rounded flex items-center">
